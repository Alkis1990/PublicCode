...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionHorisontal_RSLA = new QAction(MainWindow);
        actionHorisontal_RSLA->setObjectName(QStringLiteral("actionHorisontal_RSLA"));
        ...
        menuProc->addAction(actionLine_Split_Detailed);
        menuProc->addAction(actionWord_Split);
        menuProc->addAction(actionWord_Split_Detailed);
        menuProc->addAction(actionLines_Batch);
        menuProc->addAction(actionWords_Batch);
        menuProc->addAction(actionHorisontal_RSLA);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionHorisontal_RSLA->setText(QApplication::translate("MainWindow", "Horisontal RSLA", Q_NULLPTR));
