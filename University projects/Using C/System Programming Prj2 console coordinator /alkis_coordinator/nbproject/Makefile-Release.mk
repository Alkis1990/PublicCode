...
${OBJECTDIR}/Chain.o: Chain.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Chain.o Chain.cpp
...
${OBJECTDIR}/PoolChain.o: PoolChain.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PoolChain.o PoolChain.cpp

${OBJECTDIR}/PoolDatabase.o: PoolDatabase.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PoolDatabase.o PoolDatabase.cpp

${OBJECTDIR}/PoolWorld.o: PoolWorld.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PoolWorld.o PoolWorld.cpp
...
${OBJECTDIR}/main_coordinator.o: main_coordinator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_coordinator.o main_coordinator.cpp

${OBJECTDIR}/main_pool.o: main_pool.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_pool.o main_pool.cpp

${OBJECTDIR}/pipebuffer.o: pipebuffer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pipebuffer.o pipebuffer.cpp
